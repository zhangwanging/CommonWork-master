...
public class AddOverTimeRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setBack();
            this.findViewById(R.id.ib_add_ot_record_back).setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public void initTop() {
        ...
        tv_top_week_today.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
        ...
        tv_top_week_yesterday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cleanTop();
                tv_top_week_yesterday.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
        ...
        tv_top_week_day_before.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cleanTop();
                tv_top_week_day_before.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
    ...
    public void cleanTop() {
        ...
        tv_top_week_today.setTextColor(getResources().getColor(R.color.colorPrimaryDark));
        tv_top_week_yesterday.setBackgroundResource(R.drawable.button_ot_record_normal);
        tv_top_week_yesterday.setTextColor(getResources().getColor(R.color.colorPrimaryDark));
        tv_top_week_day_before.setBackgroundResource(R.drawable.button_ot_record_normal);
        tv_top_week_day_before.setTextColor(getResources().getColor(R.color.colorPrimaryDark));
    }
    ...
    public int getBasicHours() {
        return Integer.parseInt(tvBasicHours.getText().toString());
    }

    public int getBasicMinutes() {
        return Integer.parseInt(tvBasicMinutes.getText().toString());
    }
    ...
    public String getWorkType() {
        return tvWorkType.getText().toString();
    }
    ...
    public String getMultiply() {
        return tvMultiple.getText().toString();
    }

    public void setMultiply(String multiply) {
        tvMultiple.setText(multiply);
    }
    ...
    public void setBack() {
        ...
        ib.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setResult(OverTimeRecordFragment.CHANGE_OT_RECORD);
                finish();
            }
        });
    }
